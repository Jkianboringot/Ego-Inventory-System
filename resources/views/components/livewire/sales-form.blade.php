...
<div>
            ...
            <form wire:submit.prevent="addToList">
                <div class="card">
                    <div class="card-header bg-inv-primary text-inv-secondary border-0">
                        <h6 class="text-center">Add Customer</h6>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="" class="form-label">Customer Search</label>
                            <input type="text" wire:model.live="customerSearch" class="form-control" placeholder="Type customer's name (optional)" />
                            ...
                            <ul class="list-group mt-2 w-100">
                                ...
                                <x-customer-list-item :customer="$customer" :category="$sale" type='sale' />
                                @endforeach
                                @endif
                            </ul>
                        </div>
                ...
                <div class="card mt-2">
                    <div class="card-header bg-inv-primary text-inv-secondary border-0">
                        <h6 class="text-center">Add Sold Product</h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="col-md-8 col-6">
            <div class="card shadow" id="cart-section">
                <div class="card-header  text-inv-primary border-0">
                    <h5 class="text-center text-uppercase">Sold Products</h5>
                </div>
                <div class="card-body">
 ...
 <th class="text-center">Selling Price</th>
                   ...
                   <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-0">Empty. Add a product to Sale get started.</p>
                    </div>
                    @endif
                </div>
            </div>
