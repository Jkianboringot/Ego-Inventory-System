            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            ...
                            <input wire:model.defer='customer.name' type="text" class="form-control" name="name"
                                id="name" aria-describedby="name" placeholder="Enter customer's name" maxlength="75" minlength="5" required/>
                            @error('customer.name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea wire:model.defer='customer.address' class="form-control" name="address" id="address" rows="3" minlength='15' maxlength="255"
