            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            ...
                            <input wire:model.defer='supplier.name' type="text" class="form-control" name="name"
                                id="name" aria-describedby="name" placeholder="Enter supplier's name" maxlength="75" minlength="5" required/>
                            @error('supplier.name')
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            ...
                            <input wire:model.defer='supplier.account_number' type="text" class="form-control" name="account_number"
                                id="account_number" aria-describedby="" placeholder="Enter supplier's account number (optional)" maxlength="35" minlength="5" />
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            ...
                            <input wire:model.defer='supplier.tax_id' type="text" class="form-control" name="tax_id"
                                id="tax_id" aria-describedby="" placeholder="Enter Tax ID" maxlength="20" minlength="5" required />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea wire:model.defer='supplier.address' class="form-control" name="address" id="address" rows="3" minlength="15" maxlength="255"
