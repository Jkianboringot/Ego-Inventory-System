...
class Edit extends Component
{
    ...
    function rules()
    {
        return [
            ...
            'supplier.tax_id' => ['required', 'max:20', Rule::unique('suppliers', 'tax_id')
                ->ignore($this->supplier->id)->whereNull('deleted_at')],

            'supplier.account_number' => 'nullable', // i will allow this to be null incase customer is not affiated with an org
